...
fn generate_patrol_points(center: Vec2, radius: f32, arena_width: f32, arena_height: f32) -> Vec<Vec2> {
...
fn update_territory_ownership(
    groups: Query<(&boid_wars_shared::BoidGroup, &boid_wars_shared::Position)>,
) {
