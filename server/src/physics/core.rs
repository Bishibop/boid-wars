...
pub const POOLED_PROJECTILE_NAME: &str = "Pooled Projectile";
pub const POOLED_BOID_PROJECTILE_NAME: &str = "Pooled Boid Projectile";
pub const PROJECTILE_NAME: &str = "Projectile";
pub const BOID_PROJECTILE_NAME: &str = "Boid Projectile";
...
#[derive(Component)]
pub struct PooledProjectile(pub PooledEntity);
